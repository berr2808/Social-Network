        ...
        <FadeIn duration="300ms" >
          <form onSubmit={this.addNote} >
            <div className="c_n_header modal_header">
              <span className="title" >Crear nota</span>
              <Goto />
            </div>
            <div className="c_n_middle modal_middle">
              <input type="text" placeholder='Titulo..' required spellCheck="false" autoComplete="false" autoFocus />
            ...
            <div className="c_n_bottom modal_bottom">
              ...
              <input type="submit" className='c_n_add pri_btn' value='Agregar' />
            </div>
          </form>
        </FadeIn>
      </div>
