...
export default class Home extends React.Component{
  ...
  render(){
    let
      ...
      no_of_feeds = feeds.length == 0 ? "Sin publiciones" : feeds.length == 1 ? '1 publicacion' : `${feeds.length} Publicaciones`
      ...
      <div class='home' >
        ...
        <FadeIn duration="300ms" >
          <div className="home_info">
            ...
            >{fn.e_v() ? "Crear publicación" : "Verifique el correo electrónico"}
            </Link>
          </div>
          <Feeds />
        </FadeIn>
