    ...
    return (
      <div className="modal_items fer_items" >
        <div className="modal_it_img">
          <img src={ follow_by ? `/users/${follow_by}/user.jpg` : `/images/userPlaceholder.jpg`} />
        </div>
        <div className="modal_it_content">
          ...
          <div className="modal_ff">
            {
              fn.Me(follow_by) ?
                <Link to={`/profile/${follow_by_username}`} class='pri_btn follow' >Perfil</Link>
              : is_following ?
                <a href="#" class='pri_btn unfollow' onClick={this.unfollow} >dejar de seguir</a>
              :
